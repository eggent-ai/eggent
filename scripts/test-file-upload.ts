 ...
 * Everything it decides before touching any of them - where a name is allowed
 * to land, and what happens when the name is already taken - is decided here, where it can be tested without any of them.
 *
